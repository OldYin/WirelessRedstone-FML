...
public class WRemoteClientProxy extends WRemoteCommonProxy {
	...
	public static void initGUIs() {
		...
		NetworkRegistry.instance().registerGuiHandler(WirelessRemote.instance, WRemoteCore.proxy);
	}
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world,
			int x, int y, int z) {
		IWirelessDevice wirelessDevice = new WirelessRemoteDevice(world, player, player.getHeldItem());
		guiWirelessRemote.assWirelessDevice(wirelessDevice, player);
	...
	public boolean isRemoteOn(World world, EntityPlayer entityplayer, String freq) {
		...
		boolean flag = WirelessRemoteDevice.remoteTransmitter == null ? false
				: WirelessRemoteDevice.remoteTransmitter.getFreq().equals(freq);
		return flag;
	}
}
